...
function draw() {
  ...
  if (fixrect.shapeColor==="red" && moverect.shapeColor==="red"&&fixrect.x-moverect.x < fixrect.width/2 + moverect.width/2){
   fixrect.shapeColor="green";
   moverect.shapeColor="green";
  }
if (fixrect4.x-moverect2.x < fixrect4.width/2 + moverect2.width/2 && moverect2.shapeColor==="red" && fixrect4.shapeColor==="red"){
 fixrect4.shapeColor="green";
 moverect2.shapeColor="green";

} 
   
 if (fixrect2.x-moverect1.x < fixrect2.width/2 + moverect1.width/2&&moverect1.shapeColor==="red"&&fixrect2.shapeColor==="red")  {
  fixrect2.shapeColor="green";
  moverect1.shapeColor="green";
 }
